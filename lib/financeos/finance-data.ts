...
export const financeNavigation = [
  ...
  ["Business Value Matrix", "/finance/business-value-matrix"],
...
export const financeModules: Record<string, FinanceModule> = {
  ...
  "business-value-matrix": moduleConfig("business-value-matrix", "Business Value Matrix", "Investment readiness", ["Metric", "Value", "Score", "Risk", "Recommendation"]),
